...
echo " "
tput setaf 4;
echo "Installing Securify and it's dependencies"

echo " "
if [ "$EUID" -ne 0 ]
  then
  tput setaf 1; echo "Error installing Securify, Please run this script as root!"
...
tput setaf 2; echo "Securify is installed!!!"
...
tput setaf 2; echo "Thank you for installing Securify, happy recon!!"
